...
if(ENABLE_CUDA)
  ...
  list(APPEND CUDA_NVCC_FLAGS -DENABLE_CUDA --std c++17 -Wno-deprecated-gpu-targets --ptxas-options=-v)
  ...
  list(APPEND CUDA_NVCC_FLAGS -arch compute_75) # minumum compute level (Sps restriction)
  ...
  if(NOT uppercase_CMAKE_BUILD_TYPE MATCHES "DEBUG")
        ...
        list(APPEND CUDA_NVCC_FLAGS -gencode arch=compute_80,code=sm_80) # GTX1080Ti, Titan Xp
