...
class DedispersionPlan
{
  public:
     ...
     * @param tscrunch     The factor by which the data should be integrated in
     * time
     *
     * @details The incoherent DMs are specified absolutely, not with respect to
     * the coherent DM.
     */
     ...
     *
     * @details Implicitly sets the incoherent DM to be the same as the coherent
     * DM
     */
