...
class SkyCleaverConfig
{
    ...
    public:
        ...
        SkyCleaverConfig() : _output_dir(""), _root_dir(""), _root_prefix(""), _out_prefix(""), _nthreads(0), _nsamples_per_block(0), _nchans(0), _nbeams(0), _max_ram_gb(0), _max_output_filesize(2147483647), _stream_id(0), _nbridges(64), _ndms(0), _stokes_mode("I"), _dada_header_size(4096) {}
        ...
        void nsamples_per_block(std::size_t nsamples_per_block) { _nsamples_per_block = nsamples_per_block; }
        ...
        void max_output_filesize(std::size_t max_output_filesize) { _max_output_filesize = max_output_filesize; }
        ...
        void dada_header_size(std::size_t dada_header_size) { _dada_header_size = dada_header_size; }
